    ...
    <>
      <div className="flex justify-center gap-4">
        ...
        <button
          ...
          className="bg-transparent border border-white text-white px-8 py-3 rounded-full font-semibold text-sm tracking-wider text-center leading-none flex items-center justify-center min-w-[150px] hover:bg-white hover:text-[#6e5a49] transition-all duration-300"
        >
          CONSULENZA GRATUITA
        </button>
      </div>
